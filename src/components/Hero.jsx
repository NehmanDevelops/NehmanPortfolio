...
const Hero = () => {
  return (
    <section className={`relative w-full min-h-screen mx-auto flex items-start justify-center overflow-visible`} style={{ paddingTop: '80px' }}>
      {/* GitHub Link - Top Right */}
      <motion.div
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ delay: 0.8, duration: 0.6 }}
        className="absolute top-4 right-4 sm:top-8 sm:right-8 md:top-8 md:right-8 z-30"
      >
        <motion.a
      ...
      <motion.div
        ...
        className="absolute left-1/2 -translate-x-1/2 md:left-8 md:translate-x-0 top-24 md:top-32 z-20"
      >
      ...
      <div className={`relative w-full ${styles.paddingX} flex flex-col justify-start items-center md:items-start z-10 max-w-7xl mx-auto pt-8 sm:pt-12 md:pt-16 md:pl-64 lg:pl-80 xl:pl-96 pb-8`}>
        {/* Main Content */}
