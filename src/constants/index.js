...
const allProjects = [
  ...
  categorizeProject({
    ...
    image: `${basePath}/Images/image22.png`,
    isVideo: false,
  ...
  categorizeProject({
    name: "Gesture Control Player - Minority Report Style Interface",
    description: "A futuristic web interface that lets you control volume with hand gestures via your webcam. Built with Next.js, TypeScript, MediaPipe, and Framer Motion.",
    problemItSolves: "Traditional media controls require keyboard/mouse input, which can be awkward in hands-free contexts (presentations, cooking, accessibility). Gesture Control Player solves this by enabling intuitive, real-time volume control using camera-based hand tracking with clear on-screen feedback.",
    tags: [
    ...
    source_code_link: "https://github.com/NehmanDevelops/Gesture-Control-Player",
    isVideo: true,
  }, "fullstack"),
  ...webProject
